...
\newpage
\begingroup
\AddToShipoutPicture*{\put(139,678){\includegraphics[scale=1]{../tieude.pdf}}} 
\centering
\endgroup
\vspace*{30pt}
...
\begingroup
\AddToShipoutPicture*{\put(112,400){\includegraphics[scale=1]{../tieude2.pdf}}} 
\centering
\endgroup
\graphicspath{{../toancuabi/pic/}}
\vspace*{75pt}
...
%		\vspace*{1pt}
		\centering
		\captionsetup{labelformat= empty, justification=centering}
		\begin{tikzpicture}[toancuabi,scale=1.13]
			\fill[fill= cackithi!30] (-0.9270509831248419,2.853169548885461) -- (3.9270509831248424,2.85316954888546) -- (0.,0.) -- cycle;
			\draw  (0.,0.)-- (3.,0.);
			\draw  (3.,0.)-- (3.9270509831248424,2.85316954888546);
			\draw  (3.9270509831248424,2.85316954888546)-- (1.5,4.616525305762879);
			\draw  (1.5,4.616525305762879)-- (-0.9270509831248419,2.853169548885461);
			\draw  (-0.9270509831248419,2.853169548885461)-- (0.,0.);
			\draw  (1.5,2.06457288070676) circle (2.551952425056119cm);
			\draw  (-0.9270509831248419,2.853169548885461)-- (3.9270509831248424,2.85316954888546);
			\draw (3.9270509831248424,2.85316954888546)-- (0.,0.);
			\draw (0.,0.)-- (-0.9270509831248419,2.853169548885461);
				\draw [fill=red] (0.,0.) circle (2.0pt);
				\draw [fill=white] (3.,0.) circle (2.0pt);
				\draw [fill=red] (3.9270509831248424,2.85316954888546) circle (2.0pt);
				\draw [fill=white] (1.5,4.616525305762879) circle (2.0pt);
				\draw [fill=red] (-0.9270509831248419,2.853169548885461) circle (2.0pt);
		\end{tikzpicture}
		\vspace*{10pt}
	\end{figure}
\end{multicols}
...
\begin{multicols}{2}
	...
	\PIbox{\textbf{\color{toancuabi}Problem} $\pmb{8.}$
		Find all $4-$digit numbers ${n}$ whose sum of digits is $2010-n.$}
	\vskip 0.1cm
	\textit{Solution.}
