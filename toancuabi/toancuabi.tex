...
\newpage
\begingroup
\AddToShipoutPicture*{\put(140,678){\includegraphics[scale=1]{../tieude.pdf}}} 
\centering
\endgroup
\vspace*{30pt}
...
\begingroup
\AddToShipoutPicture*{\put(112,335){\includegraphics[scale=1]{../tieude11.pdf}}} 
\centering
\endgroup
\vspace*{45pt}
...
\begin{multicols}{2}
	...
	\begin{figure}[H]
			...
			\vspace*{5pt}
			\captionsetup{labelformat= empty, justification=centering}
			\begin{tikzpicture}[scale=0.5,toancuabi]
					\draw [] (0,0) circle (3cm);
	...
	\begin{figure}[H]
			...
			\vspace*{-10pt}
			\captionsetup{labelformat= empty, justification=centering}
			\includegraphics[width=0.7\linewidth]{bai6}
			\vspace*{-5pt}
		\end{figure}
